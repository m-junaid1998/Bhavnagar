        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="animate-fade-in">
            ...
            <div className="flex flex-col sm:flex-row gap-4 mb-12">
              ...
              className={`border-2 border-emerald-500 text-emerald-500 px-8 py-4 rounded-xl font-semibold transition-all hover:scale-105 ${isDark ? 'hover:bg-slate-800' : 'hover:bg-emerald-50'}`}>
                Donate Now
              </button>
            </div>
