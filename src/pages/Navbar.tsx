            ...
            {navbarmenu.map((item) => {
              ...
              return (
                <button
                  ...
                  } font-bold text-sm transition-colors uppercase tracking-widest outline-none group`}
                >
                  {item.name}
                  {/* Underline Animation */}
                  <span 
              ...
              {navbarmenu.map((item) => {
                ...
                return (
                  <button
                    key={item.name}
                    onClick={() => handleNavigation(item.path)}
                    className={`block text-left py-3 px-4 rounded-xl font-semibold transition-all ${
                      isActive 
